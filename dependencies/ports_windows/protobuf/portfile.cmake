...
# Fix hash_compare for VS 2015+
file(READ "${CURRENT_BUILDTREES_DIR}/src/protobuf-${PROTOBUF_VERSION}/src/google/protobuf/stubs/hash.h" HASH_H_CONTENT)
string(REPLACE 
    "# if _MSC_VER >= 1600  // Since Visual Studio 2010\n#  define GOOGLE_PROTOBUF_HAS_CXX11_HASH\n#  define GOOGLE_PROTOBUF_HASH_COMPARE std::hash_compare"
    "# if _MSC_VER >= 1600  // Since Visual Studio 2010\n#  define GOOGLE_PROTOBUF_HAS_CXX11_HASH\n#  if _MSC_VER < 1900  // hash_compare only exists before VS 2015\n#  define GOOGLE_PROTOBUF_HASH_COMPARE std::hash_compare\n#  endif"
    HASH_H_CONTENT "${HASH_H_CONTENT}")
string(REPLACE
    "#elif defined(_MSC_VER) && !defined(_STLPORT_VERSION)\n\ntemplate <typename Key>\nstruct hash : public GOOGLE_PROTOBUF_HASH_COMPARE<Key> {"
    "#elif defined(_MSC_VER) && !defined(_STLPORT_VERSION) && defined(GOOGLE_PROTOBUF_HASH_COMPARE)\n\ntemplate <typename Key>\nstruct hash : public GOOGLE_PROTOBUF_HASH_COMPARE<Key> {"
    HASH_H_CONTENT "${HASH_H_CONTENT}")
file(WRITE "${CURRENT_BUILDTREES_DIR}/src/protobuf-${PROTOBUF_VERSION}/src/google/protobuf/stubs/hash.h" "${HASH_H_CONTENT}")
