# MMKV vcpkg portfile for cross-platform (Linux/POSIX/Windows)
...
vcpkg_from_github(
    ...
    HEAD_REF master
    PATCHES
        remove-pthread-windows.patch
)

# 使用 POSIX/src 目录（支持 Linux 和 Windows）
...
if(VCPKG_TARGET_IS_WINDOWS)
    # Windows 使用 .lib 扩展名
    file(INSTALL "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/Core/core.lib"
         DESTINATION "${CURRENT_PACKAGES_DIR}/lib"
         RENAME mmkv.lib)
    file(INSTALL "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/Core/core.lib"
         DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib"
         RENAME mmkv.lib)
else()
    # Linux/POSIX 使用 .a 扩展名
...
if(NOT TARGET mmkv::mmkv)
    ...
    set_target_properties(mmkv::mmkv PROPERTIES
        IMPORTED_LOCATION_RELEASE \"\${_IMPORT_PREFIX}/lib/mmkv.lib\"
        IMPORTED_LOCATION_DEBUG \"\${_IMPORT_PREFIX}/debug/lib/mmkv.lib\"
