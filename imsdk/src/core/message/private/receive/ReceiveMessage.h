...
public:
    ...
    /// 对消息进行分类
    boost::asio::awaitable<model::OnMessageResult> ClassifyMessage(CTX_T, std::vector<std::shared_ptr<network::MsgData>> net_msgs, std::vector<std::shared_ptr<model::MessageModel>> sdk_msgs);
