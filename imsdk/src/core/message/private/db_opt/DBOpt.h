...
public:
    ...
    static bool insert_or_replace_message_when_net(CONTEXT_T, std::vector<std::shared_ptr<core::message::MessageORM>> messages);
    ...
    /// 获取会话消息
    static std::vector<std::shared_ptr<model::MessageModel>> query_messages_for_conv_id(CONTEXT_T, std::string conv_id, int64_t cursor, int64_t limit, bool forward = true);
